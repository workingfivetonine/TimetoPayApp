...
export const mergeItem = async (id: number,
  ...
  return customFetch<Item>(getMergeItemUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(mergeItemInput)
  }
);}
...
export const getGetInactiveItemsUrl = () => {




  return `/api/analytics/items/inactive`
}

/**
 * @summary Items not purchased in 30–60 days and 60+ days
 */
export const getInactiveItems = async ( options?: RequestInit): Promise<InactiveItemsResult> => {

  return customFetch<InactiveItemsResult>(getGetInactiveItemsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetInactiveItemsQueryKey = () => {
    return [
    `/api/analytics/items/inactive`
    ] as const;
    }


export const getGetInactiveItemsQueryOptions = <TData = Awaited<ReturnType<typeof getInactiveItems>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getInactiveItems>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetInactiveItemsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getInactiveItems>>> = ({ signal }) => getInactiveItems({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getInactiveItems>>, TError, TData> & { queryKey: QueryKey }
}

export type GetInactiveItemsQueryResult = NonNullable<Awaited<ReturnType<typeof getInactiveItems>>>
export type GetInactiveItemsQueryError = ErrorType<unknown>
...
export function useGetInactiveItems<TData = Awaited<ReturnType<typeof getInactiveItems>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getInactiveItems>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetInactiveItemsQueryOptions(options)
...
export const getGetCategorySpendUrl = () => {
  ...
  return `/api/analytics/category-spend`
}

/**
 * @summary Aggregate spend by item category
 */
export const getCategorySpend = async ( options?: RequestInit): Promise<CategorySpendResult> => {

  return customFetch<CategorySpendResult>(getGetCategorySpendUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetCategorySpendQueryOptions = <TData = Awaited<ReturnType<typeof getCategorySpend>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCategorySpend>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCategorySpendQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCategorySpend>>> = ({ signal }) => getCategorySpend({ signal, ...requestOptions });
...
export function useGetCategorySpend<TData = Awaited<ReturnType<typeof getCategorySpend>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCategorySpend>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getGetAnalyticsExportUrl = () => {
 ...
 */
export const getAnalyticsExport = async ( options?: RequestInit): Promise<ExportData> => {

  return customFetch<ExportData>(getGetAnalyticsExportUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetAnalyticsExportQueryKey = () => {
    return [
...
export const getGetAnalyticsExportQueryOptions = <TData = Awaited<ReturnType<typeof getAnalyticsExport>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAnalyticsExport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetAnalyticsExportQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getAnalyticsExport>>> = ({ signal }) => getAnalyticsExport({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAnalyticsExport>>, TError, TData> & { queryKey: QueryKey }
}

export type GetAnalyticsExportQueryResult = NonNullable<Awaited<ReturnType<typeof getAnalyticsExport>>>
export type GetAnalyticsExportQueryError = ErrorType<unknown>
...
export function useGetAnalyticsExport<TData = Awaited<ReturnType<typeof getAnalyticsExport>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getAnalyticsExport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetAnalyticsExportQueryOptions(options)
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetItemPriceHistoryQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getItemPriceHistory>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetStoreVisitsQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getStoreVisits>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetItemHistoryQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getItemHistory>>, TError, TData> & { queryKey: QueryKey }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetStoreSummaryQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getStoreSummary>>, TError, TData> & { queryKey: QueryKey }
}
...
export const manualEntryReceipt = async (manualEntryInput: ManualEntryInput, options?: RequestInit): Promise<ReceiptDetail> => {
  ...
  return customFetch<ReceiptDetail>(getManualEntryReceiptUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(manualEntryInput)
  }
);}
...
export const getParseAndSaveReceiptBatchUrl = () => {




  return `/api/receipts/parse-and-save-batch`
}

/**
 * @summary Parse multiple images as a single receipt (combined photo) and save it
 */
export const parseAndSaveReceiptBatch = async (parseReceiptBatchInput: ParseReceiptBatchInput, options?: RequestInit): Promise<ReceiptDetail> => {

  return customFetch<ReceiptDetail>(getParseAndSaveReceiptBatchUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(parseReceiptBatchInput)
  }
);}
...
export const getParseAndSaveReceiptBatchMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof parseAndSaveReceiptBatch>>, TError,{data: BodyType<ParseReceiptBatchInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof parseAndSaveReceiptBatch>>, TError,{data: BodyType<ParseReceiptBatchInput>}, TContext> => {

const mutationKey = ['parseAndSaveReceiptBatch'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof parseAndSaveReceiptBatch>>, {data: BodyType<ParseReceiptBatchInput>}> = (props) => {
          const {data} = props ?? {};

          return  parseAndSaveReceiptBatch(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ParseAndSaveReceiptBatchMutationResult = NonNullable<Awaited<ReturnType<typeof parseAndSaveReceiptBatch>>>
    export type ParseAndSaveReceiptBatchMutationBody = BodyType<ParseReceiptBatchInput>
    export type ParseAndSaveReceiptBatchMutationError = ErrorType<unknown>

    /**
 * @summary Parse multiple images as a single receipt (combined photo) and save it
 */
export const useParseAndSaveReceiptBatch = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof parseAndSaveReceiptBatch>>, TError,{data: BodyType<ParseReceiptBatchInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof parseAndSaveReceiptBatch>>,
        TError,
        {data: BodyType<ParseReceiptBatchInput>},
        TContext
      > => {
      return useMutation(getParseAndSaveReceiptBatchMutationOptions(options));
    }
...
export const mergeReceipts = async (mergeReceiptsInput: MergeReceiptsInput, options?: RequestInit): Promise<ReceiptDetail> => {
  ...
  return customFetch<ReceiptDetail>(getMergeReceiptsUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(mergeReceiptsInput)
  }
);}
...
export const finalizePaypalSubscription = async (paypalFinalizeInput: PaypalFinalizeInput, options?: RequestInit): Promise<CurrentUser> => {
  ...
  return customFetch<CurrentUser>(getFinalizePaypalSubscriptionUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(paypalFinalizeInput)
  }
);}
...
export const redeemPromoCode = async (redeemPromoCodeInput: RedeemPromoCodeInput, options?: RequestInit): Promise<CurrentUser> => {
  ...
  return customFetch<CurrentUser>(getRedeemPromoCodeUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(redeemPromoCodeInput)
  }
);}
...
export const adminSetUserRole = async (userId: string,
  ...
  return customFetch<AdminUser>(getAdminSetUserRoleUrl(userId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminSetRoleInput)
  }
);}
...
export const adminMergeUsers = async (adminMergeUsersInput: AdminMergeUsersInput, options?: RequestInit): Promise<AdminMergeResult> => {
  ...
  return customFetch<AdminMergeResult>(getAdminMergeUsersUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(adminMergeUsersInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAdminGetUserReceiptsQueryKey(userId);
   ...
   return  { queryKey, queryFn, enabled: userId !== null && userId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof adminGetUserReceipts>>, TError, TData> & { queryKey: QueryKey }
}
...
export const addCatalogItemToList = async (catalogAddToListInput: CatalogAddToListInput, options?: RequestInit): Promise<Item> => {
  ...
  return customFetch<Item>(getAddCatalogItemToListUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(catalogAddToListInput)
  }
);}
...
export const adminMergeCatalogItems = async (catalogMergeInput: CatalogMergeInput, options?: RequestInit): Promise<CatalogEntry> => {
  ...
  return customFetch<CatalogEntry>(getAdminMergeCatalogItemsUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(catalogMergeInput)
  }
);}
...
export const adminUpdateCatalogStore = async (id: number,
  ...
  return customFetch<CatalogEntry>(getAdminUpdateCatalogStoreUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(catalogStoreUpdate)
  }
);}
...
export const adminSplitCatalogItem = async (id: number,
  ...
  return customFetch<CatalogEntry>(getAdminSplitCatalogItemUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(catalogSplitInput)
  }
);}
...
export const adminSuggestCatalogItemCategories = async (catalogCategorySuggestInput: CatalogCategorySuggestInput, options?: RequestInit): Promise<CatalogCategorySuggestionList> => {
  ...
  return customFetch<CatalogCategorySuggestionList>(getAdminSuggestCatalogItemCategoriesUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(catalogCategorySuggestInput)
  }
);}
